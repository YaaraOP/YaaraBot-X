...
from yaarabot.utils import admin_cmd, register
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"(\w+)say (.*)"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=":/"))
async def kek(keks):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"coinflip (.*)"))
async def _(event):
...
@yaarabot.on(admin_cmd(pattern="slap(?: |$)(.*)", outgoing=True))
async def who(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="decide"))
async def _(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        if event.fwd_from:
            return
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="cry"))
async def cry(e):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="insult"))
async def insult(e):
    """I make you cry !!"""
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="cp(?: |$)(.*)"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="vapor(?: |$)(.*)"))
async def vapor(vpr):
    """Vaporize everything!"""
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="repo"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="str(?: |$)(.*)"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="zal(?: |$)(.*)"))
async def zal(zgfy):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="hi"))
async def hoi(hello):
    """Greet everyone!"""
...
@yaarabot.on(admin_cmd(pattern=r"hi2"))
async def hi(event):
    if event.fwd_from:
        return
    await event.edit("🌺✨✨🌺✨🌺🌺🌺\n🌺✨✨🌺✨✨🌺✨\n🌺🌺🌺🌺✨✨🌺✨\n🌺✨✨🌺✨✨🌺✨\n🌺✨✨🌺✨🌺🌺🌺\n☁☁☁☁☁☁☁☁")
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="kill"))
...
@yaarabot.on(events.NewMessage(pattern=r"\.(.*)", outgoing=True))
async def _(event):
