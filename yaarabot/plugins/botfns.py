...
@yaarabot.on(admin_cmd(pattern="purl ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="purl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(pattern="reader ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="reader ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="aud ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="aud ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="instadl ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="instadl ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="stats$"))
@yaarabot.on(sudo_cmd(pattern="stats$", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="xogame$"))
@yaarabot.on(sudo_cmd(pattern="xogame$", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="whisper ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="whisper ?(.*)", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="crack ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="crack ?(.*)", allow_sudo=True))
async def mod(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(pattern="checkspam ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="checkspam ?(.*), allow_sudo=True"))
async def _(event):
    bot = "@SpamBot"
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(pattern="gitdl ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="gitdl ?(.*), allow_sudo=True"))
async def _(event):
    if event.fwd_from:
        return
    if not event.reply_to_msg_id:
    ...
    async with event.client.conversation(chat) as conv:
        ...
        await x.edit(
            "Downloaded by [YaaraBot](t.me/MissKaurSupport), via @gitdownloadbot"
        )


@yaarabot.on(admin_cmd(pattern="imusic ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="imusic ?(.*)", allow_sudo=True))
async def tel(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(pattern="font ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="font ?(.*)", allow_sudo=True))
async def _(event):
    bot = "@fontsgenbot"
    if event.fwd_from:
        return
