...
@yaarabot.on(admin_cmd(pattern="get_ad?(m)in ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="get_ad?(m)in ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(pattern="get_id"))
@yaarabot.on(sudo_cmd(pattern="get_id", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    if event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="get_bot ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="get_bot ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
