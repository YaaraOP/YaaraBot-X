...
from yaarabot import ALIVE_NAME, CMD_HELP, CMD_HNDLR, CMD_LIST
...
@yaarabot.on(admin_cmd(pattern="help ?(.*)"))
async def cmd_list(event):
    if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        if tgbotusername is None or input_str == "text":
            ...
            help_string = f"""`Userbot Helper for {DEFAULTUSER} to reveal all the commands of `**[YaaraBot](https://YaaraOP.gitbook.io/yaarabot/)**\n\n"""
            try:
