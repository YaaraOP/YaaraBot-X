...
# Ported from CatUserBot for YaaraBot
...
@yaarabot.on(admin_cmd(pattern="trump(?: |$)(.*)", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="trump(?: |$)(.*)", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="modi(?: |$)(.*)", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="modi(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="cmm(?: |$)(.*)", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="cmm(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
...
@yaarabot.on(admin_cmd(pattern="kanna(?: |$)(.*)", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="kanna(?: |$)(.*)", allow_sudo=True))
async def nekobot(event):
    text = event.pattern_match.group(1)
    reply_to_id = event.message
    if event.reply_to_msg_id:
