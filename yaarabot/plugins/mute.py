...
from yaarabot.plugins.sql_helper.mute_sql import is_muted, mute, unmute
from yaarabot.utils import admin_cmd


@yaarabot.on(admin_cmd(outgoing=True, pattern=r"mute ?(\d+)?"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern=r"mute ?(\d+)?"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"unmute ?(\d+)?"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern=r"unmute ?(\d+)?"))
...
@yaarabot.on(admin_cmd(incoming=True))
