...
import yaarabot.plugins.sql_helper.blacklist_sql as sql
...
@yaarabot.on(admin_cmd(pattern="addblacklist ((.|\n)*)"))
@yaarabot.on(sudo_cmd(pattern="addblacklist ((.|\n)*)"))
...
@yaarabot.on(admin_cmd(pattern="listblacklist"))
@yaarabot.on(sudo_cmd(pattern="listblacklist"))
...
@yaarabot.on(admin_cmd(pattern="rmblacklist ((.|\n)*)"))
@yaarabot.on(sudo_cmd(pattern="rmblacklist ((.|\n)*)"))
