...
from yaarabot.plugins.sql_helper.filter_sql import (
    add_filter,
    get_all_filters,
    remove_all_filters,
    remove_filter,
...
@yaarabot.on(admin_cmd(pattern="savefilter (.*)"))
@yaarabot.on(sudo_cmd(pattern="savefilter (.*)", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="listfilters"))
@yaarabot.on(sudo_cmd(pattern="listfilters", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="clearfilter (.*)"))
@yaarabot.on(sudo_cmd(pattern="clearfilter (.*)", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="clearallfilters"))
@yaarabot.on(sudo_cmd(pattern="clearallfilters", allow_sudo=True))
