...
from yaarabot import *
from yaarabot import AUTO_PIC_FONT, AUTOPIC_FONT_COLOUR, AUTOPIC_TEXT, CMD_HELP
...
@yaarabot.on(admin_cmd(pattern="autopic"))
async def autopic(event):
    await event.edit("**Autopic has been enabled!!!**")
    a = await event.get_reply_message()
    downloaded_file_name = "userbot/original_pic.png"
    await yaarabot.download_media(a, downloaded_file_name)
    photo = "yaarabot/photo_pfp.png"
    while True:
