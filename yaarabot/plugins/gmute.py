...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"gmute ?(\d+)?"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern=r"gmute ?(\d+)?"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"ungmute ?(\d+)?"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern=r"ungmute ?(\d+)?"))
