...
# Re-written by @KashDaYash for YaaraBot
...
@yaarabot.on(admin_cmd(outgoing=True, pattern=r"direct(?: |$)([\s\S]*)"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern=r"direct(?: |$)([\s\S]*)"))
