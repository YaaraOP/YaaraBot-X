...
# Rewritten for YaaraBot by @YaaraOP

"""
This module is used for updating YaaraBot
"""
...
GIT_REPO_NAME = "YaaraBot"
UPSTREAM_REPO_URL = "https://github.com/YaaraOP/YaaraBot"
...
@yaarabot.on(admin_cmd(pattern="update ?(.*)"))
async def upstream(ups):
    ...
    if ac_br != "master":
        await ups.edit(
            ...
            "Please checkout the official branch of YaaraBot`"
        )
        repo.__del__()
        return
