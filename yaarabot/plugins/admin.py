...
from yaarabot.utils import admin_cmd, errors_handler, sudo_cmd
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="setgpic"))
@yaarabot.on(sudo_cmd(outgoing=True, pattern="setgpic", allow_sudo=True))
@errors_handler
...
@yaarabot.on(admin_cmd("promote(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(pattern="promote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="demote(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(pattern="demote(?: |$)(.*)", allow_sudo=True))
@errors_handler
...
@yaarabot.on(admin_cmd(pattern="(ban|unban) ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="(ban|unban) ?(.*)", allow_sudo=True))
async def _(event):
...
@yaarabot.on(admin_cmd(pattern="pgs ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="pgs ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="admins$"))
@errors_handler
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(outgoing=True, pattern="pin(?: |$)(.*)"))
@errors_handler
async def pin(msg):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="kick(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(outgoing=True, pattern="kick(?: |$)(.*)", allow_sudo=True))
@errors_handler
async def kick(usr):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="users ?(.*)"))
@errors_handler
