# Made By @YaaraBotComms Keep Credits If You Are Goanna Kang This Lol
...
@yaarabot.on(admin_cmd(pattern="gamerpfp ?(.*)"))
async def main(event):

    # Owner @NihiNivi
    await event.edit(
        "**Starting Gamer Profile Pic.\n\nModded by[YaaraBot](https://github.com/YaaraOP/YaaraBot)"
    )
