...
from yaarabot.plugins.sql_helper.snips_sql import (
    add_snip,
    get_all_snips,
    get_snips,
    remove_snip,
...
@yaarabot.on(events.NewMessage(pattern=r"\#(\S+)", outgoing=True))
...
@yaarabot.on(admin_cmd(pattern="snips (.*)"))
...
@yaarabot.on(admin_cmd(pattern="snipl"))
...
@yaarabot.on(admin_cmd(pattern=r"snipd (\S+)"))
