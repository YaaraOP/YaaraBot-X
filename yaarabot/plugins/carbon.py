...
from yaarabot import CHROME_DRIVER, CMD_HELP, GOOGLE_CHROME_BIN
...
@yaarabot.on(admin_cmd(pattern="carbon"))
@yaarabot.on(sudo_cmd(pattern="carbon", allow_sudo=True))
