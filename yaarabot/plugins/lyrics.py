...
@yaarabot.on(admin_cmd(outgoing=True, pattern="lyrics ?(.*)"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="lyrics ?(.*)"))
async def _(event):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="glyrics ?(.*)"))
@yaarabot.on(sudo_cmd(outgoing=True, pattern="glyrics ?(.*)", allow_sudo=True))
