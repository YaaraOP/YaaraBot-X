...
from yaarabot import CMD_HELP, OCR_SPACE_API_KEY, TEMP_DOWNLOAD_DIRECTORY, bot
...
@yaarabot.on(admin_cmd(pattern="ocr(?: |$)(.*)", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="ocr(?: |$)(.*)", allow_sudo=True))
async def ocr(event):
