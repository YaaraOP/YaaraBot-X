...
@yaarabot.on(admin_cmd(outgoing=True, pattern="spd(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="spd(?: |$)(.*)"))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with bot.conversation(chat) as conv:
        ...
        await msg.edit(
            f"Song name - __{link}__\nUploaded by [YaaraBot](https://t.me/MissKaurSupport)"
        )


@yaarabot.on(admin_cmd(outgoing=True, pattern="netease(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="netease(?: |$)(.*)"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="dzd(?: |$)(.*)"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="dzd(?: |$)(.*)"))
