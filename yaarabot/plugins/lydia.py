...
@yaarabot.on(admin_cmd(pattern="repcf", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="repcf", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="addcf", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="addcf", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="remcf", outgoing=True))
@yaarabot.on(sudo_cmd(pattern="remcf", allow_sudo=True))
