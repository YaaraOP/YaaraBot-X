...
from yaarabot.plugins.sql_helper.ghdb_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
@yaarabot.on(admin_cmd(pattern="forward ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="forward ?(.*)", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="broadcast ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="broadcast ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@yaarabot.on(admin_cmd(pattern="add ?(.*)"))
...
@yaarabot.on(admin_cmd(pattern="rm ?(.*)"))
...
@yaarabot.on(admin_cmd(pattern="listchannels"))
@yaarabot.on(sudo_cmd(pattern="listchannels", allow_sudo=True))
...
@yaarabot.on(admin_cmd(pattern="search ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="search ?(.*)", allow_sudo=True))
