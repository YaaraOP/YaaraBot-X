...
@yaarabot.on(admin_cmd(pattern="mslap ?(.*)"))
@yaarabot.on(sudo_cmd(pattern="mslap ?(.*)", allow_sudo=True))
async def who(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="mrape"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="mrape"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="mshe"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="mshe"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="mabuse"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="mabuse"))
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="mruns"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="mruns"))
async def fuckedd(abusehard):
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="minsult$"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="minsult$"))
async def proo(pros):
...
@yaarabot.on(admin_cmd(pattern=r"foryou$", outgoing=True))
@yaarabot.on(sudo_cmd(pattern=r"foryou$", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@yaarabot.on(admin_cmd(outgoing=True, pattern="kozhi"))
@yaarabot.on(sudo_cmd(allow_sudo=True, pattern="kozhi"))
