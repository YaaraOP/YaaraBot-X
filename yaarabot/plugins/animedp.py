# Made By @YaaraBotHelp Keep Credits If You Are Goanna Kang This Lol
...
@yaarabot.on(admin_cmd(pattern="animedp ?(.*)"))
async def main(event):

    await event.edit(
        "**Starting Anime Profile Pic...\n\nDone !!! Check Your DP in 5 seconds. By [YaaraBot](https://github.com/YaaraOP/YaaraBot)**"
    )
